...
test_pic_path = "test/test.jpg"
test_pic_path = "test/reg/jan_cmp.jpg"
test_pic_path = "test/reg/jan_real.jpg"
#test_pic_path = "test/reg/jan_fake.jpg"
...
for iD,lbl,conf,x0,y0,x1,y1 in res:
    if(conf > confidence_tolerance):
        ...
        y0 = int(y0 * org_h)
        y1 = int(y1 * org_h)
        face_pic = org_img[y0:y1, x0:x1]
        cv2.imwrite("a.jpg", face_pic)
        cv2.imshow("ret", face_pic)
